...
public class Veterenian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veterenian);
        ...
        recyclerView= (RecyclerView) findViewById(R.id.veterinarian_recyclerview_id);
      ...
      //  childRef= ref.child("Veterinarian");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getChildrenCount() < 1) {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Veterenian.this);
                    ...
                    alertBuilder.setNegativeButton("Go back", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Veterenian.this, Dashboard_Patient.class));
                         //   finish();
                        }
                    });
                    ...
                    Set<String> getData1 = rs.init(value, "Veterenian");


                    System.out.println("getCardiologistData() rs.init: " + getData1);

                    if (getData1.isEmpty()) {
                        AlertDialog.Builder showEmptyStatus = new AlertDialog.Builder(Veterenian.this);
