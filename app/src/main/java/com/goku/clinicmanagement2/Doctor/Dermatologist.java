...
public class Dermatologist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= (RecyclerView) findViewById(R.id.dermatologist_recyclerview_id);
       ...
       // childRef= ref.child("Dermatologist");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getChildrenCount() < 1) {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Dermatologist.this);
                    ...
                    alertBuilder.setNegativeButton("Go back", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Dermatologist.this, Dashboard_Patient.class));
                           // finish();
                        }
                    });
                    ...
                    Set<String> getData1 = rs.init(value, "Dermatologist");


                    System.out.println("getCardiologistData() rs.init: " + getData1);

                    if (getData1.isEmpty()) {
                        AlertDialog.Builder showEmptyStatus = new AlertDialog.Builder(Dermatologist.this);
