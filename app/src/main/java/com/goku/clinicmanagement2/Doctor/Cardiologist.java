...
public class Cardiologist extends AppCompatActivity{
    ...
    Formatter cardiologist__Formatter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardiologist__Formatter= new Formatter();
        ...
        recyclerView= (RecyclerView) findViewById(R.id.cardiologist_recyclerview_id);
        ...
        System.out.println("From Cardiologist path is: " + ref.getPath());

        // childRef= ref.child(" Cardiologist    ");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getChildrenCount() < 1) {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Cardiologist.this);
                    ...
                    alertBuilder.setNegativeButton("Go back", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Cardiologist.this, Dashboard_Patient.class));
                           // finish();
                        }
                    });
                    ...
                    Set<String> getData1 = rs.init(value, "Cardiologist");


                    System.out.println("getCardiologistData() rs.init: " + getData1);

                    if (getData1.isEmpty()) {
                        AlertDialog.Builder showEmptyStatus = new AlertDialog.Builder(Cardiologist.this);
