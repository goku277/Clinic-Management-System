...
import com.goku.clinicmanagement2.CPU.JoinData;
...
public class Psychiatrist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= (RecyclerView) findViewById(R.id.psychiatrist_recyclerview_id);
        ...
        System.out.println("From Psychiatrist path is: " + ref.getPath());

        // childRef= ref.child("Doctor");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getChildrenCount() < 1) {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Psychiatrist.this);
                    ...
                    alertBuilder.setNegativeButton("Go back", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Psychiatrist.this, Dashboard_Patient.class));
                         //   finish();
                        }
                    });
                    ...
                    Set<String> getData1 = rs.init(value, "Psychiatrist");


                    System.out.println("getCardiologistData() rs.init: " + getData1);

                    if (getData1.isEmpty()) {
                        AlertDialog.Builder showEmptyStatus = new AlertDialog.Builder(Psychiatrist.this);
    ...
    private boolean idDigit(String s) {
