...
public class Dentist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.dentist_recyclerview_id);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.getChildrenCount() < 1) {
                    AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Dentist.this);
                    ...
                    alertBuilder.setNegativeButton("Go back", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Dentist.this, Dashboard_Patient.class));
                           // finish();
                        }
                    });
                    ...
                    Set<String> getData1 = rs.init(value, "Dentist");


                    System.out.println("getCardiologistData() rs.init: " + getData1);

                    if (getData1.isEmpty()) {
                        AlertDialog.Builder showEmptyStatus = new AlertDialog.Builder(Dentist.this);
